		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-md-push-3 col-sm-push-3 well">
					<div class="form-group">
						<h3 class="text-center" style="color: olive;">You have successfully registered.</h3>
  					</div>
  				<br>
					<div class="form-group">
						<h4 class="text"> We will contact you soon....!!! </h4>
  						<h4 class="text"> at: <em><% out.print(request.getParameter("mail")); %></em></h4>
  					</div>
  					  			<br>	
					<div class="form-group">
						<a href="index.html"><input type="button" class="btn btn-default pull-right" value="Back" /></a>
					</div>
